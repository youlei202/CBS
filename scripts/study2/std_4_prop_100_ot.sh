...
#BSUB -o logs/resnet20/many_seeds/many_seeds_std=4_prop=1/gpu_resnet20_ot.out
#BSUB -e logs/resnet20/many_seeds/many_seeds_std=4_prop=1/gpu_resnet20_ot.err
# -- end of LSF options --
