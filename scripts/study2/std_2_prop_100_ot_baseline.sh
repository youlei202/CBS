...
#BSUB -o logs/resnet20/many_seeds/many_seeds_std=2_prop=1/gpu_resnet20_ot_baseline.out
#BSUB -e logs/resnet20/many_seeds/many_seeds_std=2_prop=1/gpu_resnet20_ot_baseline.err
# -- end of LSF options --
