...
#BSUB -o logs/resnet20/many_seeds/many_seeds_std=1_prop=0.1/gpu_resnet20_reg=inf_ot_baseline.out
#BSUB -e logs/resnet20/many_seeds/many_seeds_std=1_prop=0.1/gpu_resnet20_reg=inf_ot_baseline.err
# -- end of LSF options --
...
REG="--reg ${ot_reg}"
DUMP_OT="--dump-ot-files"
extra_cmd=" ${ONE_SHOT} ${OPTIMAL_TRANSPORTATION}  ${ADD_NOISE} ${REG} ${DUMP_OT}"
