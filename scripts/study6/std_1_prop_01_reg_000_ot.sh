...
#BSUB -o logs/resnet20/many_seeds/many_seeds_std=1_prop=0.1/gpu_resnet20_reg=0_ot.out
#BSUB -e logs/resnet20/many_seeds/many_seeds_std=1_prop=0.1/gpu_resnet20_reg=0_ot.err
# -- end of LSF options --
