...
#BSUB -oo logs/resnet50/many_seeds/sparsity_0.95_std=1_prop=0.2_ot.out
#BSUB -eo logs/resnet50/many_seeds/sparsity_0.95_std=1_prop=0.2_ot.err
# -- end of LSF options --
...
SWEEP_NAME="sparsity_0.95_std=1_prop=0.2_ot"
NOWDATE=""
DQT='"'
GPUS=(0)
