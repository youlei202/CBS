...
#BSUB -oo logs/resnet50/many_seeds/sparsity_0.95_std=0_prop=0_ot_baseline.out
#BSUB -eo logs/resnet50/many_seeds/sparsity_0.95_std=0_prop=0_ot_baseline.err
# -- end of LSF options --
...
SWEEP_NAME="sparsity_0.95_std=0_prop=0_ot_baseline"
NOWDATE=""
DQT='"'
GPUS=(0)
