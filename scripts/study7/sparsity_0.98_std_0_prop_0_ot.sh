...
#BSUB -oo logs/resnet50/many_seeds/sparsity_0.98_std=0_prop=0_ot.out
#BSUB -eo logs/resnet50/many_seeds/sparsity_0.98_std=0_prop=0_ot.err
# -- end of LSF options --
...
SWEEP_NAME="sparsity_0.98_std=0_prop=0_ot"
NOWDATE=""
DQT='"'
GPUS=(0)
