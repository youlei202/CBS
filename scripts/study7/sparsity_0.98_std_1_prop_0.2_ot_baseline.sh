...
#BSUB -oo logs/resnet50/many_seeds/sparsity_0.98_std=1_prop=0.2_ot_baseline.out
#BSUB -eo logs/resnet50/many_seeds/sparsity_0.98_std=1_prop=0.2_ot_baseline.err
# -- end of LSF options --
...
SWEEP_NAME="sparsity_0.98_std=1_prop=0.2_ot_baseline"
NOWDATE=""
DQT='"'
GPUS=(0)
